...
func Defaults() *Catalog {
	return New([]Dataset{
		...
		{ID: "public-medical-device-sales", Name: "医疗设备销售公开资料", Description: "来自厂商官网和国家药监局公开来源的产品事实摘要、销售核验与安全售后分诊资料", Product: "medical-device-sales", Visibility: "public", Status: "active"},
