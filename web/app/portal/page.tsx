  ...
  return (
    <main className="portal-shell">
      ...
      <section className="portal-main">
        ...
        {view === "ingest" && <><IngestView datasets={datasets} selected={selectedDataset} setSelected={setSelectedDataset} isPlatformAdmin={isPlatformAdmin} document={document} setDocument={setDocument} loadFile={(file) => void loadDocumentFile(file)} submit={importDocument} importing={importing} /><IngestionTaskBoard summary={ingestionSummary} error={ingestionError} refreshing={ingestionRefreshing} refresh={() => void refreshDatasetJobs()} mutate={mutateDatasetJob} /></>}
