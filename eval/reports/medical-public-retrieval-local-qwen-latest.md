...
- 生成时间：2026-08-31T18:26:31.957380Z
- 数据：39 份公开事实摘要，197 条 Golden Cases
- 选定切分：350 字符，重叠 60 字符
- 执行模式：真实语义模型：Qwen3-Embedding-4B-Q4_K_M（2560 维）+ heuristic-rerank
- 发布门禁：**passed**
...
| `v6-provider-selective-rag` | `development` | 43 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| `v6-provider-selective-rag` | `regression` | 30 | 1.000 | 1.000 | 0.900 | 0.921 | 1.000 |
| `v6-provider-selective-rag` | `acceptance` | 22 | 1.000 | 1.000 | 0.977 | 0.983 | 1.000 |
